...
title(giflayout,'Short Configuration (High Speed Mode)')
subtitle(giflayout,'Foot Velocity = .24 m/s')
nexttile([3 3])
    ...
    drawnow
    % pause(1)
    exportgraphics(gcf,'shortHS.gif','Append',true);
end
